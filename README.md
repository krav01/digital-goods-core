...
**Статус:** этап 1b — реализованы заказы, долговечный inbox платежей, очередь выдачи, миграции PostgreSQL и поставщик A с отдельной БД. Полный запуск и интеграционные проверки выполняются в CI. Поставщик B и испытания гонок независимых процессов — следующие этапы.
