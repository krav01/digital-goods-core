...
Для этапа 1b реализованы тесты A01, A05, A07, последовательный повтор A04, базовые конфликты A06, модель сбоя A15 и проверка старой аренды A16. Их запуск с PostgreSQL ожидает проверки CI. Остальные строки пока запланированы; модель сбоя внутри теста не заменяет проверку независимых процессов на этапе 2.
